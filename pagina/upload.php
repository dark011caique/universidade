...
if (isset($_FILES['foto']) && $_FILES['foto']['error'] === UPLOAD_ERR_OK) {
    $targetDir = 'caminho/para/diretorio/de/imagens/'; // Especifique o diretório onde as imagens serão armazenadas
    ...
    if ($uploadOk) {
        if (move_uploaded_file($_FILES['foto']['tmp_name'], $targetFile)) {
            ...
            $foto = 'caminho/para/diretorio/de/imagens/' . basename($_FILES['foto']['name']);
